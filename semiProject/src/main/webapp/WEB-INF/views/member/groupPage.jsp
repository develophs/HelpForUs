		...
		<div class="row">
    		<div class="col-2 border border-dark border-2">
   			...
   			<div class="col-8 border border-dark border-2">
   				<h4 style="padding:10px;">봉사 단체 목록</h4>
				  ...
				  <tbody>
				  	<c:forEach items="${ groupList }" var="gList" varStatus="status">
					    <tr>
					      <th scope="row">${ status.count }</th>
					      <td>${ gList.memberUsername }</td>
					      <td>${ gList.memberNickname }</td>
					      <td>${ gList.memberPhone }</td>
					      <td>${ gList.memberEmail }</td>
					      <td>${ gList.memberEnrollDate }</td>
					      <td>Y</td>
					    </tr>
				    </c:forEach>
				  </tbody>
